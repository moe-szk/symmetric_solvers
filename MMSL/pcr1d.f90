...
!
!-------------------------------------------------------------------------------
subroutine pcr1d(kmax,n,nzu,nzl,iu,il,au,al,ad,ksu,ksl,b,x,eps,itmax,iopt)
  ...
  call wpcr1d(kmax,n,nzu,nzl,iu,il,au,al,ad,ksu,ksl,b,x,eps,itmax,iopt,&
       uu,ul,ud)
  return
end subroutine pcr1d
