subroutine wpcr1d(n_nzr,n,nzu,nzl,iu,il,au,al,ad,ksu,ksl,b,x,eps,itmax,iopt,&
  ...
  call icsl1d(n,nzu,nzl,iu,il,uu,ul,ud,r,p,int(ksu),int(ksl))
  ...
  call icsl1d(n,nzu,nzl,iu,il,uu,ul,ud,ap,kap,int(ksu),int(ksl))
  ...
  do j=1,itmax
     ...
     kr1 = kr - alpha * kap
     call prod1d(n,nzu,nzl,iu,il,au,al,ad,kr1,akr1,int(ksu),int(ksl))
     ...
     call icsl1d(n,nzu,nzl,iu,il,uu,ul,ud,ap1,kap,int(ksu),int(ksl))
