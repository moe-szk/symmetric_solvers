...
!
!-------------------------------------------------------------------------------
subroutine esmr1d(n_nzr,n,nzu,nzl,iu,il,au,al,ad,ksu,ksl,b,x,eps,itmax,iopt, &
     omg)
  ...
  real(8),dimension(n)::v0vec,v1vec,v2vec,w0vec,w1vec,w2vec,u1vec
